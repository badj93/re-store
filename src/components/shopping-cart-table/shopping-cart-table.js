...
import {bookAddedToCart, bookDeleteToCart, bookMinusCountToCart } from "../../actions";
...
const mapDispatchToProps = (dispatch) => {
  return {
    onDelete: (id) => dispatch(bookDeleteToCart(id)),
    onDecrease: (id) => dispatch(bookMinusCountToCart(id)),
